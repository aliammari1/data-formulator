...
const BooleanIcon: React.FC<IconProps> = ({ className, fontSize, ...props }) => {
    return (
        <svg 
            className={cn(getIconSize(fontSize), className)} 
            viewBox="0 0 24 24" 
            fill="currentColor" 
            {...props}
        >
...
const StringIcon: React.FC<IconProps> = ({ className, fontSize, ...props }) => {
    return (
        <svg 
            className={cn(getIconSize(fontSize), className)} 
            viewBox="0 0 24 24" 
...
const NumericalIcon: React.FC<IconProps> = ({ className, fontSize, ...props }) => {
    return (
        <svg 
            className={cn(getIconSize(fontSize), className)} 
            viewBox="0 0 24 24" 
...
const DateIcon: React.FC<IconProps> = ({ className, fontSize, ...props }) => {
    return (
        <svg 
            className={cn(getIconSize(fontSize), className)} 
            viewBox="0 0 24 24" 
...
const UnknownIcon: React.FC<IconProps> = ({ className, fontSize, ...props }) => {
    return (
        <svg 
            className={cn(getIconSize(fontSize), className)} 
            viewBox="0 0 24 24" 
